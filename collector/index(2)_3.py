...
for req_genre in req_genres:
    ...
    while pages < 8200:
        try:
            r_tracks = client.get('/tracks', limit = 200, offset = pages,  created_at = { 'from' : '2013-01-01 00:00:00' , 'to' : '2013-07-01 00:00:00'}, genres = req_genre, license = 'cc-by-sa', order='created_at')
            if not(r_tracks):
                break
